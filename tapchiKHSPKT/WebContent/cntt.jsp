  ...
  <div class="row">
   ...
   <div class="col-md-2" >
      <div class="btn-group btn-group-justified" align="center" style="margin: 100 0 0 0;">
        <a href="dn.html" class="btn btn-primary">Đăng Nhập</a>
        <a href="dk.html" class="btn btn-primary">Đăng Ký</a>
      </div>
   </div>
  </div>
  </div>
      ...
      <div class="row">
        ...
        <a href="x0.html">
          <div class="module" style="background:linear-gradient(rgba(0, 0, 0, 0.1),rgba(0, 0, 0, 0.1)),url(image/a.jpg);">
            <header>
              <h4>
                Camera kép trên iPhone 7 Plus:<br> Không phải là tính năng mới
              </h4  >
            </header>
          </div>
        </a>
