                      ...
                      <form class="form-horizontal" >
                          ...
                          <label  class="col-sm-2">Mật khẩu cũ:</label>
                                   <div class="col-sm-10"><p>
                                        <input type="password" name="passwordol" class="form-control"  placeholder="Password" ng-model="passwordol"  required>
                                        <i class="form-control-feedback glyphicon glyphicon-password glyphicon-ok" ng-show="myForm.passwordol.$dirty && myForm.passwordol.$valid">
                                        </i></p>
                                    </div>
                        </div>
                         <div class="form-group" style="clear: both;">
