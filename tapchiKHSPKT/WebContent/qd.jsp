  ...
  <div class="row">
   ...
   <div class="col-md-8">
      ...
      <div class="btn-group btn-group-justified">
        <a href="tc.jsp" class="btn btn-primary">TRANG CHỦ</a>
        <a href="cctc.jsp" class="btn btn-primary">CƠ CẤU TỔ CHỨC</a>
        <a href="qd.jsp" class="btn btn-primary">QUY ĐỊNH</a>
        <a href="lh.jsp" class="btn btn-primary">LIÊN HỆ</a>
      </div>  
   </div>
   <div class="col-md-2" >
    ...
    <div class="container-fluid" >
      <div class="row">
        ...
        <div class="btn-group-vertical" align="center">
          LĨNH VỰC
          <a href="cntt.jsp" class="btn btn-primary">CÔNG NGHỆ THÔNG TIN</a>
          <a href="ddt.jsp" class="btn btn-primary">ĐIỆN - ĐIỆN TỬ</a>
          <a href="ckctm.jsp" class="btn btn-primary">CƠ KHÍ CHẾ TẠO MÁY</a>
          <a href="hhtp.jsp" class="btn btn-primary">HÓA HỌC & THỰC PHẨM</a>
          <a href="llct.jsp" class="btn btn-primary">LÝ LUẬN CHÍNH TRỊ</a>
          <a href="khtn.jsp" class="btn btn-primary">KHOA HOC TỰ NHIÊN</a>
          <a href="th.jsp" class="btn btn-primary"> TRIẾT HỌC</a>
        </div>
...
<h1><b>Chương II 
 TỔ CHỨC BỘ MÁY VÀ CHẾ ĐỘ LÀM VIỆC</b></h1>
...
<h1><b>Chương V 
QUY ĐỊNH XÉT DUYỆT VÀ ĐĂNG BÀI TRÊN TẠP CHÍ</b></h1>
