        ...
        <div class="col-md-10">
                ...
                <div class="panel-body">
                  <div class="form-group" style="clear: both;">
                     <label >Tiêu đề</label>
                     <input type="text" name="head" class="form-control" value="Camera kép trên iPhone 7 Plus: Không phải là tính năng mới" disabled>
                  </div>
                  <div class="form-group" style="clear: both;">
                     <label >Nội dung chính</label>
                    <textarea class="form-control" rows="10" cols="80" disabled>Apple đã công bố iPhone 7 Plus với hai camera ở mặt sau. Có thể với nhiều người dùng đây
                ...
                <div class="panel-body" >
                   ...
                   <form>
                    <textarea name="editor1" id="editor1" rows="10" cols="80"></textarea>
                      ...
                      <button type="button" name="submit" class="btn btn-default" style="width: 100px;" data-toggle="modal" data-target="#myModal">Phản biện</button>
