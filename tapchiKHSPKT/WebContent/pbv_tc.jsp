  ...
  <div class="row">
   ...
   <div class="col-md-8">
      ...
      <div class="btn-group btn-group-justified">
        <a href="pbv_tc.jsp" class="btn btn-primary">TRANG CHỦ</a>
        <a href="pbv_cctc.jsp" class="btn btn-primary">CƠ CẤU TỔ CHỨC</a>
        <a href="pbv_qd.jsp" class="btn btn-primary">QUY ĐỊNH</a>
        <a href="pbv_lh.jsp" class="btn btn-primary">LIÊN HỆ</a>
      </div>  
   </div>
   <div class="col-md-2" >
    ...
    <div class="container-fluid" >
      <div class="row">
        ...
        <div class="btn-group-vertical" align="center">
          LĨNH VỰC
          <a href="pbv_cntt.jsp" class="btn btn-primary">CÔNG NGHỆ THÔNG TIN</a>
          <a href="pbv_ddt.jsp" class="btn btn-primary">ĐIỆN - ĐIỆN TỬ</a>
          <a href="pbv_ckctm.jsp" class="btn btn-primary">CƠ KHÍ CHẾ TẠO MÁY</a>
          <a href="pbv_hhtp.jsp" class="btn btn-primary">HÓA HỌC & THỰC PHẨM</a>
          <a href="pbv_llct.jsp" class="btn btn-primary">LÝ LUẬN CHÍNH TRỊ</a>
          <a href="pbv_khtn.jsp" class="btn btn-primary">KHOA HOC TỰ NHIÊN</a>
          <a href="pbv_th.jsp" class="btn btn-primary"> TRIẾT HỌC</a>
        </div>
