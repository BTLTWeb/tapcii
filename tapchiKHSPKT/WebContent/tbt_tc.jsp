  ...
  <div class="row">
   <div class="col-md-2">
     <div class="btn-group-vertical" align="center" style="margin: 10 0 0 0">
          ...
          <a href="tbt_db.jsp" class="btn btn-primary">Danh sách tài khoản</a>
        </div>
   </div>
   <div class="col-md-8">
      <div align="center">
      ...
      <div class="btn-group btn-group-justified">
        <a href="tbt_tc.jsp" class="btn btn-primary">TRANG CHỦ</a>
        <a href="tbt_cctc.jsp" class="btn btn-primary">CƠ CẤU TỔ CHỨC</a>
        <a href="tbt_qd.jsp" class="btn btn-primary">QUY ĐỊNH</a>
        <a href="tbt_lh.jsp" class="btn btn-primary">LIÊN HỆ</a>
      </div>  
   </div>
   <div class="col-md-2" >
    ...
    <div class="container-fluid" >
      <div class="row">
        ...
        <div class="btn-group-vertical" align="center">
          LĨNH VỰC
          <a href="tbt_cntt.jsp" class="btn btn-primary">CÔNG NGHỆ THÔNG TIN</a>
          <a href="tbt_ddt.jsp" class="btn btn-primary">ĐIỆN - ĐIỆN TỬ</a>
          <a href="tbt_ckctm.jsp" class="btn btn-primary">CƠ KHÍ CHẾ TẠO MÁY</a>
          <a href="tbt_hhtp.jsp" class="btn btn-primary">HÓA HỌC & THỰC PHẨM</a>
          <a href="tbt_llct.jsp" class="btn btn-primary">LÝ LUẬN CHÍNH TRỊ</a>
          <a href="tbt_khtn.jsp" class="btn btn-primary">KHOA HOC TỰ NHIÊN</a>
          <a href="tbt_th.jsp" class="btn btn-primary"> TRIẾT HỌC</a>
        </div>
