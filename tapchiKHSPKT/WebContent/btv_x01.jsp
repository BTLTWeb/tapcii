  ...
  <div class="row">
   ...
   <div class="col-md-8">
      ...
      <div class="btn-group btn-group-justified">
        <a href="btv_tc.html" class="btn btn-primary">TRANG CHỦ</a>
        <a href="btv_cctc.html" class="btn btn-primary">CƠ CẤU TỔ CHỨC</a>
        <a href="btv_qd.html" class="btn btn-primary">QUY ĐỊNH</a>
        <a href="btv_lh.html" class="btn btn-primary">LIÊN HỆ</a>
      </div>  
   </div>
   <div class="col-md-2" >
    ...
    <div class="container-fluid" >
      <div class="row">
        ...
        <div class="btn-group-vertical" align="center">
          LĨNH VỰC
          <a href="btv_cntt.html" class="btn btn-primary">CÔNG NGHỆ THÔNG TIN</a>
          <a href="btv_ddt.html" class="btn btn-primary">ĐIỆN - ĐIỆN TỬ</a>
          <a href="btv_ckctm.html" class="btn btn-primary">CƠ KHÍ CHẾ TẠO MÁY</a>
          <a href="btv_hhtp.html" class="btn btn-primary">HÓA HỌC & THỰC PHẨM</a>
          <a href="btv_llct.html" class="btn btn-primary">LÝ LUẬN CHÍNH TRỊ</a>
          <a href="btv_khtn.html" class="btn btn-primary">KHOA HOC TỰ NHIÊN</a>
          <a href="btv_th.html" class="btn btn-primary"> TRIẾT HỌC</a>
        </div>
        ...
        <div class="col-md-10">
                ...
                <div class="panel-body">
                    <div class="form-group" style="clear: both;">
                     <label >Tiêu đề</label>
                     <input type="text" name="head" class="form-control" value="Camera kép trên iPhone 7 Plus: Không phải là tính năng mới">
                  </div>
                  <div class="form-group" style="clear: both;">
                     <label >Nội dung chính</label>
                    <textarea name="editor1" id="editor1" rows="10" cols="80">Apple đã công bố iPhone 7 Plus với hai camera ở mặt sau. Có thể với nhiều người dùng đây

là tính năng mới lần đầu tiên được biết đến. Tuy nhiên thực tế tính năng camera kép đã có một

lịch sử phát triển 6 năm cho đến nay.</textarea>
                  </div>
                    <h3>Lĩnh vực<select name="Mon" size = 1 onChange="Call DocGiaTriListBox" class="form-control" disabled>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body" > 
              <iframe frameborder="0" src="https://drive.google.com/file/d/0B2k0PlH0F0SJa0I3clZwdmJaWVk/preview" style="height: 500px; width:1070px;"></iframe>
                ...
                <div class="panel panel-default">
                <div class="panel-body" >
                      <button type="button" name="submit" class="btn btn-default" style="width: 100px;" data-toggle="modal" data-target="#myModal">Nộp bài</button>
