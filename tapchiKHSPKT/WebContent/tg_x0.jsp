    ...
    <div class="container-fluid" >
      <div class="row">
        ...
        <div class="btn-group-vertical" align="center">
          LĨNH VỰC
          <a href="tg_cntt.html" class="btn btn-primary">CÔNG NGHỆ THÔNG TIN</a>
          <a href="tg_ddt.html" class="btn btn-primary">ĐIỆN - ĐIỆN TỬ</a>
          <a href="tg_ckctm.html" class="btn btn-primary">CƠ KHÍ CHẾ TẠO MÁY</a>
          <a href="tg_hhtp.html" class="btn btn-primary">HÓA HỌC & THỰC PHẨM</a>
          <a href="tg_llct.html" class="btn btn-primary">LÝ LUẬN CHÍNH TRỊ</a>
          <a href="tg_khtn.html" class="btn btn-primary">KHOA HOC TỰ NHIÊN</a>
          <a href="tg_th.html" class="btn btn-primary"> TRIẾT HỌC</a>
        </div>
