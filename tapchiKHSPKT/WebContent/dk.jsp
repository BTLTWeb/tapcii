                ...
                <div class="panel-body">
                   <form ng-app="myApp" ng-controller="validateCtrl" name="myForm" novalidate>
                      <form class="form-horizontal" >
                        <div class="form-group  has-feedback" show-errors='{showSuccess: true}' style="clear: both;">
                          <label class="control-label required col-sm-2" for="user">Tên đăng nhập*:</label>
                          <div class="col-sm-10">           
                            <p>
                        ...
                        <div class="form-group" has-feedback" show-errors='{showSuccess: true}' style="clear: both;">
                          ...
                          <div class="col-sm-10"> <p>          
                              <input type="password" name="password" class="form-control"  placeholder="Password" ng-model="password" class="ng-pristine ng-valid" required>
                              ...
                              <span ng-show="myForm.password.$error.required">Mật khẩu là bắt buộc.</span>
                              </p>
                          </div>
                        </div>
                        <div class="form-group" has-feedback" show-errors='{showSuccess: true}' style="clear: both;">
                          <label  class="control-label required col-sm-2" for="repassword">Xác nhận mật khẩu*:</label>
                          <div class="col-sm-10"> <p>          
                                  <input type="repassword" name="repassword" class="form-control" id="exampleInputPassword2" placeholder="Repassword" ng-model="repassword"  password-match="password" required>
                                   <i class="form-control-feedback glyphicon glyphicon-password glyphicon-ok" ng-show="myForm.repassword.$dirty && myForm.repassword.$valid">
                              </i>
                                  <span style="color:red" ng-show="myForm.repassword.$dirty && myForm.repassword.$invalid && myForm.repassword.$error.unique">Mật khẩu không trùng khớp.</span>
                                   <span style="color:red" ng-show="myForm.repassword.$touched && myForm.repassword.$invalid">
                                  <span ng-show="myForm.repassword.$error.required">Xác nhận mật khẩu là bắt buộc.</span>
                                  </p>
                          </div>
                        </div>
                        <div class="form-group" has-feedback" show-errors='{showSuccess: true}' style="clear: both;">
                          <label class="control-label required col-sm-2" for="email">Địa chỉ email*:</label>
                          <div class="col-sm-10">           
                              <p>
                              <input type="email" name="email" class="form-control"  placeholder="Email" ng-model="email" required>
                              <i class="form-control-feedback glyphicon glyphicon-password glyphicon-ok" ng-show="myForm.email.$dirty && myForm.email.$valid">
                              </i>
                        ...
                        <div class="form-group" style="clear: both;">
                          ...
                          <div class="col-sm-10"> <p >          
                                  Nam<input type="radio" checked="checked" name="gt" style="margin: 0 20 0 20;">  Nữ <input type="radio" name="gt" style="margin: 0 0 0 20;">
                                  </p>
                          </div>
                        </div>
                        ...
                        <div class="form-group " style="clear: both;">
                          <label class="control-label required col-sm-2" for="phone">Điện thoại*:</label>
                          <div class="col-sm-10"><p>           
                                  <input type="text" name="phone" class="form-control"  placeholder="Phone" ng-model="phone" ng-minlength="10" ng-maxlength="12" ng-pattern="/^[0-9]+$/" required>
                                   <i class="form-control-feedback glyphicon glyphicon-password glyphicon-ok" ng-show="myForm.phone.$dirty && myForm.phone.$valid">
                              </i>
                          ...
                          <div class="form-group" style="clear: both;">
                          <label  class="control-label required col-sm-2" for="CMND">Số CMND:</label>
                          <div class="col-sm-10"><p>           
                                  <input type="text" name="CMND" class="form-control"  placeholder="CMND" ng-model="CMND" ng-minlength="9" ng-maxlength="12" ng-pattern="/^[0-9]+$/" required>
                                  <i class="form-control-feedback glyphicon glyphicon-password glyphicon-ok" ng-show="myForm.phone.$dirty && myForm.phone.$valid">
                                  </i>
                                  <span style="color:red" ng-show="myForm.CMND.$dirty && myForm.CMND.$invalid">
                                  <span ng-show="myForm.CMND.$error.minlength">Đây không phải là số CMND.</span>
                                  <span ng-show="myForm.CMND.$error.maxlength">Đây không phải là số CMND.</span>
                                  <span ng-show="myForm.CMND.$error.pattern">Hãy nhập số.</span>
                                  </span>
                                  </p>
                          </div>
                        </div>
                         <div class="form-group" style="clear: both;">
                          ...
                          <div class="col-sm-10"><p> 
                                  <textarea class="form-control" placeholder="Tên cơ quan" rows="4" required></textarea>
                                  </p>
                          </div>
                          </div>
                          <div class="form-group" style="clear: both;">
                          ...
                          <div class="col-sm-10"><p> 
                                  <textarea class="form-control" placeholder="Địa chỉ   "  rows="4" required ></textarea>
                                  </p>
                          </div>
                          </div>
                          <div class="form-group" style="clear: both;">
                          <label  class="control-label required col-sm-2" for="email1">Địa chỉ email dự phòng*:</label>
                          <div class="col-sm-10">           
                              <p>
                              <input type="email" name="email1" class="form-control"  placeholder="Email" ng-model="email1" required>
                              <i class="form-control-feedback glyphicon glyphicon-password glyphicon-ok" ng-show="myForm.email1.$dirty && myForm.email1.$valid">
                              </i>
                              <span style="color:red" ng-show="myForm.email1.$dirty && myForm.email1.$invalid">
                              <span ng-show="myForm.email1.$error.email">Không đúng định dạng email.</span>
                              </span>
                              </p> 
                          </div>
                        </div><p><br>
                        <h4>* Chỉ các trường hợp bắt buộc</h4>
                        </p>
                        
                          <div class="form-group">
                            <div align="center">
                            <div class="container"  style="width: 700;height: 40; margin: auto;">
                            <button type="button"  name="submit" class="btn btn-default" style="width: 100px;" data-toggle="modal" data-target="#myModal" ng-disabled="!myForm.$dirty || (myForm.$dirty && myForm.$invalid)">Đăng ký</button>
