      ...
      <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div class="panel-body" > 
              ...
              <div class="panel panel-default">
              <div class="panel-heading">
                <h4 class="panel-tiile" align="center" style="">Phản biện</h4>
              </div>
                <div class="panel-body"  align="center">
                <div>
                    <label class="col-sm-2">Văn A:</label>
                    <label class="col-sm-10">Hay</label>
                </div>
                <div>
                    <label class="col-sm-2 col-sm-ofsset-8">16/9/2016</label> 
                    <label class="col-sm-2">6:16pm</label>
                     
                </div>
                <div style="clear: both;">
                    <label class="col-sm-2">Văn B:</label>
                    <label class="col-sm-10">Cũng được</label>
                    </div>
                    <div>
