  ...
  <div class="row">
   <div class="col-md-2">
     <div class="btn-group-vertical" align="center" style="margin: 10 0 0 0">
          <a href="ad_dstk.jsp" class="btn btn-primary">Danh sách tài khoản</a>
   </div>
   </div>
   <div class="col-md-8">
      <div align="center">
      ...
      <div class="btn-group btn-group-justified">
        <a href="ad_tc.html" class="btn btn-primary">TRANG CHỦ</a>
        <a href="ad_cctc.html" class="btn btn-primary">CƠ CẤU TỔ CHỨC</a>
        <a href="ad_qd.html" class="btn btn-primary">QUY ĐỊNH</a>
        <a href="ad_lh.html" class="btn btn-primary">LIÊN HỆ</a>
      </div>  
   </div>
   <div class="col-md-2" >
   ...
   <div class="panel panel-default" style="margin: 50 0 0 0;">
    <div class="panel-heading">
      <h4 class="panel-tiile" align="center" style=""> Admin:  Thanh Tâm </h4>
    </div>
    <div class="panel-body">
    <div class="btn-group btn-group-justified">
      <a href="ad_tt.jsp" class="btn btn-primary"> Thông tin </a>
    ...
    <div class="container-fluid" >
      <div class="row">
        ...
        <div class="btn-group-vertical" align="center">
          LĨNH VỰC
          <a href="ad_cntt.html" class="btn btn-primary">CÔNG NGHỆ THÔNG TIN</a>
          <a href="ad_ddt.html" class="btn btn-primary">ĐIỆN - ĐIỆN TỬ</a>
          <a href="ad_ckctm.html" class="btn btn-primary">CƠ KHÍ CHẾ TẠO MÁY</a>
          <a href="ad_hhtp.html" class="btn btn-primary">HÓA HỌC & THỰC PHẨM</a>
          <a href="ad_llct.html" class="btn btn-primary">LÝ LUẬN CHÍNH TRỊ</a>
          <a href="ad_khtn.html" class="btn btn-primary">KHOA HOC TỰ NHIÊN</a>
          <a href="ad_th.html" class="btn btn-primary"> TRIẾT HỌC</a>
        </div>
